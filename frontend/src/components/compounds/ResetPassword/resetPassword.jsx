        ...
        <div className ="signin__wrapper">
          <form style={{ position: 'relative' }} onSubmit={onSubmitHandler}>
            ...
            <div className="signin-wrapper-email">
                <Text.Heading text="New Password" size={16} weight={450} level={3} />
                <Input.FullRound name="password_1" type="password" placeholder="" onChange={onChangeHandler} />
                {error?<p className="error">{error.email}</p>:''}
            </div>
            <div className="signin-wrapper-email">
                <Text.Heading text="Confirm Password" size={16} weight={450} level={3} />
                <Input.FullRound name="password_2" type="password" placeholder="" onChange={onChangeHandler} />
                {error?<p className="error">{error.email}</p>:''}
            </div>
